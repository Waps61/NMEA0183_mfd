...
lv_obj_set_style_bg_color(circle, lv_obj_get_style_bg_color(scale, LV_PART_MAIN), 0);
...
lv_obj_set_style_text_font(hr_value_label, &ui_font_lv_conthrax_40, 0);
...
lv_obj_set_style_text_font(bpm_label, &ui_font_lv_conthrax_16, 0);
